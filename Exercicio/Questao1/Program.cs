...
namespace Questao1 {
    class Program {
        ...
        private static string ExibirDadosDaConta(IContaBancaria conta)
        {
            return $"Conta { conta.NumeroDaConta}, Titular: { conta.NomeTitular}, Saldo: $ {conta.Saldo.ToString("0.00", CultureInfo.InvariantCulture)}";
